...
public class Countries {
    ...
    static int getSavedCountryIndex(SharedPreferences preferences) {
        return preferences.getInt(COUNTRY_KEY, EGYPT_INDEX);
    }

    static void saveCountryIndex(SharedPreferences preferences, int index) {
